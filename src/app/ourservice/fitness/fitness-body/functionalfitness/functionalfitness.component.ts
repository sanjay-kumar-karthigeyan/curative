...
@Component({
  selector: 'app-functionalfitness',
  templateUrl: './functionalfitness.component.html',
  styleUrls: ['./functionalfitness.component.css']
})
export class FunctionalfitnessComponent implements OnInit {
