...
@Component({
  selector: 'app-page-footer-body',
  templateUrl: './page-footer-body.component.html',
  styleUrls: ['./page-footer-body.component.css']
})
export class PageFooterBodyComponent implements OnInit {
